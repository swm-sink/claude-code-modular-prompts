...
<module name="project_priming" category="context">
  ...
  <implementation>
    ...
    <phase name="findings_documentation" order="4">
      <requirements>
        Context priming completed with comprehensive project understanding
        Analysis data collected and structured for documentation
        Document generation framework initialized and ready
        Project insights synthesized for written output
      </requirements>
      <actions>
        Generate comprehensive project analysis document with findings
        Create structured project overview with architecture assessment
        Document identified issues, technical debt, and improvement opportunities
        Compile development patterns, conventions, and workflow recommendations
        Generate executive summary with critical findings and recommendations
        Save analysis document to project_comms/context-analysis-[timestamp].md
        Include actionable insights for immediate development workflow optimization
        Provide strategic recommendations for long-term project improvement
      </actions>
      <document_structure>
        <project_overview>
          <architecture_summary>High-level system design and structure analysis</architecture_summary>
          <technology_stack>Frameworks, libraries, and tools in use</technology_stack>
          <project_complexity>Size, scope, and complexity assessment</project_complexity>
          <development_context>Recent activity, active work, and team patterns</development_context>
        </project_overview>
        <findings_analysis>
          <strengths_identified>Well-implemented patterns and good practices</strengths_identified>
          <issues_discovered>Technical debt, problems, and areas for improvement</issues_discovered>
          <patterns_recognized>Development patterns, conventions, and workflows</patterns_recognized>
          <dependencies_assessment>External and internal dependency analysis</dependencies_assessment>
        </findings_analysis>
        <recommendations>
          <immediate_improvements>Quick wins and immediate optimization opportunities</immediate_improvements>
          <workflow_enhancements>Development process and methodology improvements</workflow_enhancements>
          <technical_upgrades>Technology and architecture improvement suggestions</technical_upgrades>
          <long_term_strategy>Strategic recommendations for project evolution</long_term_strategy>
        </recommendations>
      </document_structure>
      <validation>
        Comprehensive analysis document generated with structured findings
        Project overview accurately reflects analyzed codebase and context
        Issues and recommendations documented with actionable insights
        Document saved successfully and accessible for immediate use
      </validation>
    </phase>
