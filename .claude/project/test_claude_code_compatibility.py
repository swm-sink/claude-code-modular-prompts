#!/usr/bin/env python3
"""
Test Claude Code compatibility for all command files
"""
import os
import re
import yaml
...
def test_command_compatibility(file_path):
    ...
    try:
        ...
        # 9. Test for old format issues
        if 'tools:' in yaml_content:
            compatibility_issues.append("Found old 'tools:' field - should be 'allowed-tools:'")
...
def main():
    ...
    print("🧪 Claude Code Compatibility Testing")
    print("=" * 50)
