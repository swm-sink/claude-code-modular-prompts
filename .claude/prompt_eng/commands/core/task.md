...
<command purpose="Execute research-first focused development tasks with RISE framework and MANDATORY TDD cycle">
  ...
  <domain_customization>
    <insertion_points>
      <quality_standards>[PROJECT_CONFIG: quality_standards | DEFAULT: framework_defaults]</quality_standards>
      <test_framework>[PROJECT_CONFIG: code_quality.test_framework | DEFAULT: language_appropriate]</test_framework>
      <coverage_threshold>[PROJECT_CONFIG: test_coverage.threshold | DEFAULT: 90]%</coverage_threshold>
      <performance_targets>[PROJECT_CONFIG: performance | DEFAULT: 200ms_p95]</performance_targets>
    </insertion_points>
    
    <domain_specific_checks>
      [PROJECT_CONFIG: domain_specific_rules | DEFAULT: none]
      <!-- Examples:
      - Web: Check accessibility, responsive design, SEO
      - Mobile: Check lifecycle, memory usage, platform guidelines
      - Data: Check data validation, pipeline integrity, processing efficiency
      - Security: Check threat model, vulnerability scan, compliance
      -->
    </domain_specific_checks>
    
    <workflow_customization>
      <test_command>[PROJECT_CONFIG: commands.test | DEFAULT: auto_detect]</test_command>
      <lint_command>[PROJECT_CONFIG: commands.lint | DEFAULT: auto_detect]</lint_command>
      <build_command>[PROJECT_CONFIG: commands.build | DEFAULT: auto_detect]</build_command>
    </workflow_customization>
  </domain_customization>
    ...
    <checkpoint id="1" verify="true" enforcement="BLOCKING" thinking_mode="interleaved">
      ...
      <interleaved_thinking enforcement="MANDATORY">
        ...
        <critical_thinking minimum_time="30_seconds">
          ...
          [PROJECT_CONFIG: domain_specific_questions | DEFAULT: none]
        </critical_thinking>
        <decision_reasoning>
