...
<prompt_component>
  <description>Advanced component implementation for chaos-engineering</description>
...
</failure_simulation>  <chaos_engineering><resilience_testing><!-- Implement chaos engineering for system resilience testing </resilience_testing><failure_simulation><system_level_chaos><infrastructure_failures>Simulate infrastructure-level failures:
...
</experiment_scheduling>      <automated_chaos_orchestration><!-- Automated chaos experiment execution and management </automated_chaos_orchestration><experiment_scheduling><intelligent_scheduling>Smart scheduling of chaos experiments:
        ...
        <safety_mechanisms><blast_radius_control>Control and limit experiment impact:
          ...
          <circuit_breaker_integration>Integrate with existing resilience patterns:
...
</experiment_monitoring>    <observability_integration><!-- Deep integration with monitoring and observability systems </observability_integration><experiment_monitoring><real_time_metrics><system_health_tracking>Monitor system health during chaos experiments:
...
</governance_framework>    <enterprise_chaos_management><!-- Enterprise-grade chaos engineering governance and processes </enterprise_chaos_management><governance_framework><experiment_approval><risk_assessment>Comprehensive risk assessment for chaos experiments:
...
</multi_dimensional_chaos>    <advanced_chaos_scenarios><!-- Advanced chaos engineering scenarios and techniques </advanced_chaos_scenarios><multi_dimensional_chaos><compound_failure_scenarios><cascading_failure_simulation>Simulate complex cascading failure scenarios:
