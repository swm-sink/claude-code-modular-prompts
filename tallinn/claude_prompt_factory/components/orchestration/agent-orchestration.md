...
<prompt_component>
  ...
  <agent_orchestration><multi_agent_coordination><!-- Advanced multi-agent orchestration framework </multi_agent_coordination><orchestration_patterns>```xml<command>agent-orchestration
<params><!-- Core Orchestration Configuration </params><orchestration_pattern>hierarchical_coordination
  <agents><count>8</count>
    <heterogeneous>true</heterogeneous>
    <specialization>dynamic</specialization>
  </agents> -->
  
  <!-- Coordination Strategy 
  <coordination><pattern>distributed_consensus</pattern>
  ...
  <communication><protocol>message_passing_interface</protocol>
  ...
  <!-- Task Decomposition 
  <task_management><decomposition>hierarchical_breakdown</decomposition>
  ...
  <!-- Adaptation Settings 
  <adaptation><role_switching>enabled</role_switching>
