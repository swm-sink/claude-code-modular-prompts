...
<prompt_component>
  ...
  <cognitive_architecture><hybrid_cognitive_systems><!-- Advanced cognitive architecture implementation 
      <architecture_selection>```xml</architecture_selection><command>cognitive-architecture
<params><!-- Core Architecture Selection <!-- Core Architecture Selection 
  ...
  <!-- ACT-R Configuration <!-- ACT-R Configuration 
  <act_r><declarative_memory><chunk_activation>true</chunk_activation>
  ...
  <soar><working_memory><capacity>unlimited</capacity>
    ...
    <decision_cycle><elaboration_phase>true</elaboration_phase>
  ...
  <!-- CLARION Configuration <!-- CLARION Configuration 
  <clarion><dual_process><explicit_system><rule_based>true</rule_based>
        <symbolic_reasoning>true</symbolic_reasoning>
        <working_memory_capacity>7</working_memory_capacity>
      </explicit_system>
      <implicit_system><neural_networks>true</neural_networks>
  ...
  <hybrid_features><architecture_switching><enabled>true</enabled>
  ...
  <learning_systems><types><skill_acquisition>true</skill_acquisition>
  ...
  <monitoring><cognitive_load><measurement>resource_utilization</measurement>
