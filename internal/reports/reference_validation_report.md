...
- Line 289: `[Full Threat Model](evidence/security/{task_id}/threat-model.json)` → `evidence/security/{task_id}/threat-model.json`
- Line 295: `[Scan Reports](evidence/security/{task_id}/scans/)` → `evidence/security/{task_id}/scans/`
- Line 301: `[Verification Evidence](evidence/security/{task_id}/mitigations/)` → `evidence/security/{task_id}/mitigations/`

### .claude/system/quality/tdd-verification.md

- Line 246: `[red-phase-evidence.json](evidence/tdd/{task_id}/red-phase.json)` → `evidence/tdd/{task_id}/red-phase.json`
- Line 252: `[green-phase-evidence.json](evidence/tdd/{task_id}/green-phase.json)` → `evidence/tdd/{task_id}/green-phase.json`
- Line 258: `[refactor-evidence.json](evidence/tdd/{task_id}/refactor.json)` → `evidence/tdd/{task_id}/refactor.json`

### docs/CONTRIBUTING.md

- Line 39: `[CLAUDE.md](CLAUDE.md)` → `CLAUDE.md`
...
- Line 477: `[Universal Quality Gates](.claude/modules/quality/universal-quality-gates.md)` → `.claude/modules/quality/universal-quality-gates.md`
...
- Line 270: `[Advanced Patterns](../user-guide/workflows/advanced-patterns.md)` → `../user-guide/workflows/advanced-patterns.md`
- Line 271: `[Performance Optimization](../advanced/performance-optimization.md)` → `../advanced/performance-optimization.md`

### docs/getting-started/installation.md

- Line 308: `[Team Configuration](../user-guide/customization/team-setup.md)` → `../user-guide/customization/team-setup.md`
- Line 311: `[Performance Guide](../advanced/performance-optimization.md)` → `../advanced/performance-optimization.md`

### docs/getting-started/quick-start.md

- Line 98: `[Advanced Workflows](../user-guide/workflows/advanced-patterns.md)` → `../user-guide/workflows/advanced-patterns.md`
- Line 99: `[Team Configuration](../user-guide/customization/team-setup.md)` → `../user-guide/customization/team-setup.md`

### docs/guides/USER_GUIDE.md

- Line 418: `[GETTING_STARTED.md](docs/GETTING_STARTED.md)` → `docs/GETTING_STARTED.md`
- Line 419: `[Documentation Index](docs/DOCUMENTATION_INDEX.md)` → `docs/DOCUMENTATION_INDEX.md`
...
- Line 553: `[Universal Quality Gates](../../.claude/modules/quality/universal-quality-gates.md)` → `../../.claude/modules/quality/universal-quality-gates.md`
...
- Line 477: `[Optimization Guide](../../advanced/performance-optimization.md)` → `../../advanced/performance-optimization.md`

### docs/user-guide/workflows/common-patterns.md

- Line 383: `[Advanced Workflows](advanced-patterns.md)` → `advanced-patterns.md`
- Line 384: `[Team Workflows](team-patterns.md)` → `team-patterns.md`
- Line 385: `[Production Workflows](production-patterns.md)` → `production-patterns.md`
- Line 389: `[Advanced Workflows](advanced-patterns.md)` → `advanced-patterns.md`
- Line 391: `[Team Patterns](team-patterns.md)` → `team-patterns.md`

### examples/advanced/README.md

- Line 254: `[.claude/modules/quality/](../../.claude/modules/quality/)` → `../../.claude/modules/quality/`
- Line 263: `[.claude/modules/security/](../../.claude/modules/security/)` → `../../.claude/modules/security/`
...
- Line 340: `[.claude/modules/quality/](../../../.claude/modules/quality/)` → `../../../.claude/modules/quality/`

### examples/quick-start/first-task/README.md

- Line 203: `[docs/quality/tdd.md](../../../.claude/modules/quality/tdd.md)` → `../../../.claude/modules/quality/tdd.md`
- Line 205: `[docs/quality/universal-quality-gates.md](../../../.claude/modules/quality/universal-quality-gates.md)` → `../../../.claude/modules/quality/universal-quality-gates.md`

### examples/workflows/long-running-session/README.md

- Line 370: `[.claude/modules/development/project-management.md](../../../.claude/modules/development/project-management.md)` → `../../../.claude/modules/development/project-management.md`
- Line 371: `[.claude/modules/development/progress-tracking.md](../../../.claude/modules/development/progress-tracking.md)` → `../../../.claude/modules/development/progress-tracking.md`
- Line 372: `[.claude/modules/development/team-coordination.md](../../../.claude/modules/development/team-coordination.md)` → `../../../.claude/modules/development/team-coordination.md`
- Line 375: `[.claude/modules/quality/universal-quality-gates.md](../../../.claude/modules/quality/universal-quality-gates.md)` → `../../../.claude/modules/quality/universal-quality-gates.md`
- Line 376: `[.claude/modules/development/validation/](../../../.claude/modules/development/validation/)` → `../../../.claude/modules/development/validation/`
- Line 377: `[.claude/system/session/production-protocols.md](../../../.claude/system/session/production-protocols.md)` → `../../../.claude/system/session/production-protocols.md`
...
- Line 313: `[.claude/modules/quality/universal-quality-gates.md](../../../.claude/modules/quality/universal-quality-gates.md)` → `../../../.claude/modules/quality/universal-quality-gates.md`
- Line 314: `[.claude/modules/development/testing/](../../../.claude/modules/development/testing/)` → `../../../.claude/modules/development/testing/`
- Line 315: `[.claude/modules/development/validation/](../../../.claude/modules/development/validation/)` → `../../../.claude/modules/development/validation/`

### examples/workflows/research-plan-implement/README.md

- Line 307: `[docs/quality/universal-quality-gates.md](../../../.claude/modules/quality/universal-quality-gates.md)` → `../../../.claude/modules/quality/universal-quality-gates.md`
...
- `research-plan-implement/`: 3 references
- `../long-running-session/`: 3 references
...
- docs/advanced/framework-components/module-runtime-engine.md: `.claude/modules/quality/universal-quality-gates.md`
...
- docs/user-guide/commands/overview.md: `../../.claude/modules/quality/universal-quality-gates.md`
- docs/user-guide/commands/overview.md: `../../.claude/modules/patterns/thinking-pattern-template.md`
- examples/advanced/README.md: `../../.claude/modules/quality/`
- examples/advanced/README.md: `../../.claude/modules/security/`
